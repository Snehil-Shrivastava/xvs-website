...
// const BlogsPage = ({ searchParams }: Props) => {
//   return (
...
// No searchParams here — this component is now static.
// Filter state is read client-side via useSearchParams inside BlogMainClient.
