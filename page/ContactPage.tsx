  ...
  return (
    ...
    >
      ...
      <div className="w-9/10 1920p:w-4/5 max-lg:mx-auto max-w-450 relative">
        ...
        <div className="bg-background/10 backdrop-blur-md relative z-5 contact-clip-content flex flex-col md:max-lg:gap-5 lg:max-xl:gap-10 justify-center md:max-xl:py-10 m-px">
          <SectionHeading
            className="max-sm:text-[3.7rem] sm:max-md:text-[5rem] md:max-lg:text-8xl lg:max-xl:text-9xl xl:max-1440p:text-[150px] 1440p:max-2xl:text-[170px] 2xl:text-[180px]"
            headingText="connect"
            buttonText="contact"
            buttonIcon={
              <Heart
