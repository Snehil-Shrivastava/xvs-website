...
//               className="text-center flex flex-col gap-5 max-md:gap-1.5 md:max-lg:gap-2 px-12 max-md:px-4 md:max-lg:px-6 xl:max-2xl:px-8 py-15 max-md:py-8 md:max-lg:py-10"
//             >
