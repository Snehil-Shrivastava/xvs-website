        ...
        <SwiperSlide key={index} className="relative services-slide">
          ...
          >
            ...
            <Link
              ...
              className="text-center flex flex-col gap-5 max-md:gap-1.5 md:max-lg:gap-2 px-12 max-md:px-4 md:max-lg:px-6 xl:max-1440p:px-8 py-15 max-md:py-8 md:max-lg:py-10"
            >
              <h3 className="2240p:text-[68px]/[72px] max-sm:text-2xl sm:max-md:text-3xl md:max-lg:text-[34px]/[35px] lg:max-xl:text-4xl xl:max-1440p:text-5xl max-sm:leading-7 font-calSans">
                {services.cardTitle}
              </h3>
