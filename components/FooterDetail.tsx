...
const FooterDetail = () => {
  ...
  return (
    <div className="relative">
      <div className="py-15 max-md:pt-3 max-md:pb-5 2xl:max-w-[85%] max-sm:w-9/10 md:max-lg:w-9/10 mx-auto flex gap-70 md:max-lg:gap-15 relative z-5">
        ...
        <div className="flex-1 relative font-poppins">
          <div className="flex justify-between w-full max-sm:w-full sm:max-md:w-9/10 mx-auto h-full max-sm:gap-5 md:max-lg:gap-8">
            <div className="flex flex-col gap-8 max-sm:gap-4 sm:max-md:gap-6 max-lg:flex-[0.55]">
              <span className="font-semibold text-[26px] max-sm:text-sm sm:max-md:text-lg md:max-lg:text-sm">
                Contact
              </span>
              <div className="flex flex-col justify-between flex-1 md:gap-15">
                <div className="flex gap-20 max-sm:gap-12 sm:max-md:gap-25 md:max-lg:gap-15 relative">
                  <div className="flex flex-col text-xl max-sm:text-[10px] sm:max-lg:text-sm">
                    <span className="font-bold">Lucknow,</span>
                    <span className="text-brand-cream text-base max-sm:text-[8px] sm:max-lg:text-[10px]">
                      Uttar Pradesh, India
                    </span>
                  </div>
                  <div className="flex flex-col text-xl max-sm:text-[10px] sm:max-lg:text-sm">
                ...
                <div className="flex items-center max-md:flex-col max-md:items-start gap-10 max-md:gap-3">
                  <h3 className="text-[60px]/[62px] max-sm:text-[28px]/[28px] sm:max-md:text-4xl md:max-lg:text-4xl font-calSans flex flex-col max-md:flex-row max-md:gap-1.5">
                    <span className="text-4xl max-sm:text-[28px]/[28px] sm:max-md:text-4xl md:max-lg:text-xl">
                      Say
                    </span>
                    <span>Hi!</span>
                  </h3>
                  <p className="flex flex-col text-xl max-sm:text-[10px] sm:max-lg:text-[10px] text-brand-cream">
            ...
            <div className="flex flex-col gap-8 max-sm:gap-4 sm:max-md:gap-6 max-lg:flex-[0.45]">
              <span className="font-semibold text-[26px] max-sm:text-sm sm:max-md:text-lg md:max-lg:text-sm">
                Services
              </span>
              <div className="grid grid-cols-2 gap-x-15 md:max-lg:gap-x-8 gap-y-2 max-md:flex max-md:flex-col max-md:gap-2 text-brand-cream">
                {footerServices.map((service, index) => (
                  <Link
                    ...
                    className="hover:underline text-xl max-sm:text-[10px] sm:max-lg:text-[10px]"
                  >
                    {service.heading}
                  </Link>
                ))}
      ...
      {/* dividing lines */}
      <div className="absolute h-px w-[75%] max-md:w-full md:max-lg:w-[78%] bg-[#f7983944] top-[28%] max-sm:top-[12%] sm:max-md:top-[15%] right-0" />
      ...
      <div className="absolute h-[18%] max-md:h-[16%] w-px bg-[#f7983944] right-[65.5%] max-sm:right-[69%] sm:max-md:right-[73%] md:max-lg:right-[58%] top-[28%] max-sm:top-[12%] sm:max-md:top-[15%]" />
    </div>
  );
};
