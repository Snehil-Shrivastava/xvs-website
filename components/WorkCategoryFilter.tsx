...
const WorkCategoryFilter = ({
  ...
  useGSAP(
    () => {
      ...
      mm.add("(min-width: 1280px)", () => buildTimeline("239px"));
    },
  ...
  return (
    <>
      <div
        ...
        data-work-filter
        className="flex flex-wrap items-center justify-center gap-4 2xl:gap-5 bg-background relative z-10 py-5 font-poppins"
      >
