...
const WorkCategoryFilter = ({
  ...
  useGSAP(
    () => {
      ...
      mm.add("(max-width: 639px)", () => buildTimeline("119px"));
      ...
      mm.add("(min-width: 1280px)", () => buildTimeline("319px"));
    },
...
// -------------------------------------- fixing showcase heading disappear issue
...
//       data-work-filter
//       className="
//         flex flex-wrap items-center justify-center gap-4 2xl:gap-5
//         bg-background z-10 pb-5 font-poppins
//         sticky
//         top-[150px] sm:top-[180px] md:top-[200px] lg:top-[210px] xl:top-[320px]
//       "
//     >
//       <div className="flex flex-col md:flex-row flex-wrap gap-4 max-sm:gap-4 max-sm:w-[95%] max-sm:mx-auto items-center justify-center w-full md:w-auto">
//         {/* Mobile Carousel Layout */}
