    ...
    <div className="flex items-center justify-center h-full">
      <div className="max-w-350 w-4/5 max-md:w-9/10 sm:max-md:max-w-130 mx-auto relative font-calSans">
        ...
        <div className="bg-background relative py-20 max-md:py-15 flex flex-col gap-20 max-md:gap-8 agency-client-content">
          <div className="font-poppins flex flex-col gap-15 max-md:gap-10 md:max-lg:text-xl lg:max-xl:text-2xl xl:max-2xl:text-3xl 2xl:max-1728p:text-4xl 1728p:text-[40px] text-center max-md:px-10 px-15 font-light">
            <q>
          ...
          <div className="flex max-md:flex-col max-md:items-center max-sm:gap-10 sm:max-md:gap-15 justify-between md:w-4/5 md:mx-auto">
            <div className="flex flex-col max-md:gap-4 gap-10 items-center max-sm:w-50 sm:max-md:w-80 sm:max-md:justify-center">
              <div className="flex max-md:flex-col max-md:gap-4 gap-10 items-center">
                <div className="relative">
                  <span className="text-brand-orange font-apercu-black text-7xl max-sm:text-5xl sm:max-md:text-6xl">
                    4.8
                  </span>
                  <Star
              ...
              <Link
                ...
                className="text-brand-orange underline font-poppins font-light max-md:text-base text-2xl"
              >
                See more reviews
              </Link>
            </div>
            <div className="flex flex-col max-md:gap-4 gap-10 items-center max-sm:w-50 sm:max-md:w-80 sm:max-md:justify-center">
              <div className="flex max-md:flex-col max-md:gap-4 gap-10 items-center">
                <div className="text-7xl max-sm:text-5xl sm:max-md:text-6xl font-apercu-black">
              ...
              <Link
                href={"/work"}
                className="bg-brand-orange px-4 1728p:px-8 font-medium max-sm:text-sm 2xl:max-1728p:text-xl 1728p:text-2xl btn-clip max-md:py-2 1728p:py-2 button-clip flex max-sm:items-start items-center gap-2"
              >
                <Image
                  src={lambda}
                  alt="lambda"
