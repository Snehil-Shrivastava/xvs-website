...
const HomeReel = () => {
  return (
    <div className="flex justify-center items-center h-full relative">
      <div className="bg-white w-9/10 max-md:w-9/10 max-sm:max-w-120 sm:max-md:max-w-180 md:max-1440p:w-9/10 1440p:max-2xl:w-9/10 max-w-450 container-clip-both">
        <Video
          src={showreel}
