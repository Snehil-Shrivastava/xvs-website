  ...
  return (
    <div className="flex items-center justify-center h-full">
      <div className="max-w-350 w-4/5 max-lg:w-9/10 sm:max-md:max-w-130 mx-auto relative font-calSans">
        ...
        <div className="bg-background relative py-20 max-md:py-15 md:max-lg:py-15 flex flex-col gap-20 max-md:gap-8 md:max-lg:gap-10 agency-client-content">
          <div>
            ...
            <div className="w-7/10 md:max-lg:w-4/5 mx-auto grid grid-cols-2 gap-x-15 max-md:gap-x-8 md:max-lg:gap-x-10 gap-y-25 max-md:gap-y-15 md:max-lg:gap-y-15 relative pt-15 justify-center font-calSans">
              <div className="flex max-md:flex-col gap-10 max-md:gap-5 md:max-lg:gap-6 items-center justify-start">
                ...
                />
                <span className="text-[28px] max-sm:text-lg sm:max-md:text-lg md:max-lg:text-xl max-md:text-center">
                  NDA Ready
                </span>
              </div>
              <div className="flex max-md:flex-col gap-10 max-md:gap-5 md:max-lg:gap-6 items-center justify-start">
