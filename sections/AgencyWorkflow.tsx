      ...
      <div className="max-w-350 w-4/5 max-md:w-9/10 sm:max-md:max-w-130 mx-auto relative font-calSans">
        ...
        <div className="bg-background relative py-20 max-md:py-15 flex flex-col gap-20 max-md:gap-8 agency-client-content">
          <div>
            ...
            <div className="w-7/10 mx-auto grid grid-cols-2 gap-x-15 max-md:gap-x-8 gap-y-25 max-md:gap-y-15 relative pt-15 justify-center font-calSans">
          ...
          <p className="font-light font-poppins max-sm:text-sm sm:max-lg:text-base lg:max-2xl:text-lg 2xl:max-1728p:text-xl 1728p:text-2xl text-center px-25 max-md:px-0">
