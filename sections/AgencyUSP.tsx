          ...
          <div className="max-w-350 w-9/10 max-lg:w-9/10 sm:max-md:max-w-130 mx-auto relative font-calSans">
            ...
            <div className="bg-background relative py-20 md:max-xl:py-15 flex flex-col gap-20 md:max-xl:gap-10 agency-client-content">
              <div className="flex max-md:flex-col max-md:gap-10 justify-around items-center relative">
                ...
                <div className="flex gap-10 md:max-lg:gap-8 items-center max-sm:w-50 sm:max-md:w-80 sm:max-md:justify-center">
                  ...
                  <div>
                    ...
                    <ClutchLogo
                      width="112"
                      height="40"
                      className="max-sm:w-20 md:max-lg:w-18 md:max-lg:h-8 lg:max-xl:w-20 lg:max-xl:h-8"
                    />
                  </div>
                </div>
                <div className="flex gap-10 md:max-lg:gap-8 items-center max-sm:w-50 sm:max-md:w-80 sm:max-md:justify-center">
                  <div className="text-7xl max-sm:text-5xl sm:max-md:text-6xl md:max-lg:text-[2.5rem] lg:max-xl:text-6xl font-apercu-black">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-4xl max-sm:text-2xl md:max-lg:text-2xl lg:max-xl:text-3xl font-medium max-md:font-calSans">
                      Reviews
                    </span>
                  </div>
                </div>
                <div className="flex gap-10 md:max-lg:gap-8 items-center max-sm:w-50 sm:max-md:w-80 sm:max-md:justify-center">
                  <div className="relative">
                    <span className="text-brand-orange text-7xl max-sm:text-5xl sm:max-md:text-6xl md:max-lg:text-[2.5rem] lg:max-xl:text-6xl font-apercu-black">
                      4.8
                    </span>
                    <Star
                      className="absolute w-12 max-lg:w-5 -top-5 -right-10 max-lg:-right-5"
              ...
              <div>
                ...
                <div className="w-7/10 md:max-lg:w-4/5 mx-auto grid grid-cols-2 gap-x-15 md:max-lg:gap-x-10 gap-y-25 md:max-xl:gap-y-15 relative pt-15 justify-center font-calSans">
