  ...
  return (
    <div className="flex items-center justify-center h-full">
      <div className="max-w-350 w-9/10 max-lg:w-9/10 sm:max-md:max-w-130 mx-auto relative font-calSans">
        ...
        <div className="bg-background relative py-20 max-md:py-8 md:max-xl:py-15 px-20 max-lg:px-10 flex flex-col gap-15 max-md:gap-8 agency-client-content">
          ...
          <div className="w-9/10 max-md:w-full lg:max-2xl:w-full mx-auto grid grid-cols-2 max-lg:grid-cols-1 gap-x-15 gap-y-25 max-md:gap-y-10 md:max-xl:gap-y-15 relative font-calSans">
            <div className="flex gap-10 max-sm:gap-4 md:max-lg:gap-6 lg:max-xl:gap-6 items-center">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex flex-col text-2xl max-sm:text-lg lg:max-xl:text-xl">
                  <span>Branding</span>
                  <span>& Identity Systems</span>
                </div>
                <p className="font-extralight max-sm:text-sm lg:max-xl:text-sm text-xl font-poppins">
