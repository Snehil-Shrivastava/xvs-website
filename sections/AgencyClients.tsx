    ...
    <div className="flex items-center justify-center h-full">
      <div className="max-w-350 w-4/5 max-md:w-9/10 mx-auto relative font-calSans">
        ...
        <div className="bg-background relative py-20 max-md:py-8 px-20 max-md:px-10 flex flex-col gap-15 max-md:gap-8 agency-client-content">
          ...
          <div className="w-4/5 max-md:w-9/10 mx-auto grid grid-cols-2 max-md:grid-cols-1 gap-x-65 gap-y-25 max-md:gap-y-10 relative">
            <div className="flex gap-10 items-center">
              <Image src={MarketingSVG} alt="marketing" className="w-8" />
            ...
            <div className="flex gap-10 items-center">
              <Image src={SocialMediaSVG} alt="social media" className="w-8" />
              <div className="flex flex-col text-2xl max-sm:text-lg">
            ...
            <div className="flex gap-10 items-center">
              <Image src={MediaSVG} alt="media" className="w-8" />
              <div className="flex flex-col text-2xl max-sm:text-lg">
            ...
            <div className="flex gap-10 items-center">
              <Image src={GrowingSVG} alt="start up" className="w-8" />
              <div className="flex flex-col text-2xl max-sm:text-lg">
          ...
          <p className="font-light font-sans max-md:text-sm md:max-lg:text-base lg:max-2xl:text-lg 2xl:max-1728p:text-xl 1728p:text-2xl text-center px-25 max-md:px-0">
