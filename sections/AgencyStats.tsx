    ...
    <div className="flex items-center justify-center h-full">
      <div className="max-w-350 w-4/5 max-md:w-9/10 mx-auto relative font-calSans">
        ...
        <div className="bg-background relative py-20 max-md:py-10 agency-stat-content">
          <div className="w-4/5 max-ms:w-auto mx-auto grid grid-cols-2 max-md:grid-cols-1 gap-x-65 gap-y-25 max-md:gap-y-10 relative">
            <hr className="absolute top-1/2 -translate-y-1/2 max-sm:top-20 w-full h-px border-brand-orange/50" />
            ...
            <div className="flex gap-20 max-md:gap-15 items-center max-md:justify-center">
              <div className="relative">
                <span className="text-brand-orange text-8xl max-sm:text-5xl">
                  4.8
                </span>
                <Image
                  src={ratingCardSVG}
              ...
              <div className="">
                <span className="text-2xl max-sm:text-sm font-medium">
                  Rated on
                </span>
            ...
            <div className="flex gap-15 items-center max-md:justify-center">
              <div>
                ...
                <span className="text-8xl max-sm:text-5xl">+</span>
              </div>
              <div className="flex flex-col">
                <span className="text-2xl max-sm:text-sm font-medium">
                  Verified
                </span>
                <span className="text-5xl max-sm:text-2xl font-medium max-md:font-sans">
                  Reviews
                </span>
              </div>
            </div>
            <div className="flex gap-15 items-center justify-start max-md:justify-center">
              <div className="flex flex-col-reverse">
                ...
                <span className="text-5xl max-sm:text-2xl font-medium">
                  Trusted
                </span>
              </div>
              <div>
            ...
            <div>
              <Link
                ...
                className="flex items-center text-nowrap bg-brand-orange px-9 max-md:px-4 py-6 max-md:py-2.5 rounded-[72px] text-4xl max-sm:text-sm sm:max-md:text-lg gap-6 font-semibold cursor-pointer select-none"
              >
                <Image
                  src={scheduleMeetingSVG}
                  alt="schedule a meeting"
                  className="max-sm:w-10 sm:max-md:w-7"
                />
                <div className="flex flex-col">
