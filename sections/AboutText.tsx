...
const AboutText = () => {
  return (
    <div className="flex flex-col items-center max-md:h-full max-md:justify-center gap-15 max-md:gap-8">
      ...
      />
      <p className="text-brand-cream w-350 max-sm:w-9/10 sm:max-md:w-4/5 mx-auto text-center text-[1.8rem]/[3rem] max-sm:text-[12px]/[20px] sm:max-md:text-base font-extralight">
