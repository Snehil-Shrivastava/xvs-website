    ...
    <div className="flex items-center justify-center h-full">
      <div className="max-w-350 w-4/5 max-md:w-9/10 sm:max-md:max-w-130 mx-auto relative font-calSans">
        ...
        <div className="bg-background relative py-20 max-md:py-15 flex flex-col gap-20 max-md:gap-8 agency-client-content">
          <div className="w-4/5 mx-auto flex max-md:flex-col max-sm:gap-15 sm:max-md:gap-18 gap-15 max-md:py-10 py-15">
            <div className="flex flex-col items-center max-md:gap-6 gap-10">
              ...
              <div className="flex flex-col max-md:items-center md:gap-1.5">
                <span className="text-brand-orange max-sm:text-2xl sm:max-md:text-3xl text-4xl text-center">
                  Project-Based
                </span>
